...
class TransformerDecoderLayer {
 public:
  ...
  void Forward(const T *dec_input_ptr, const T *dec_mask_ptr, const T *enc_output_ptr,
  ...
  void self_attn_layer_fw(const T *input_ptr, const T *mask_ptr, T *output_ptr, T *buffer,
                          std::vector<T *> &cache);
