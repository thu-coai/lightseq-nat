# LightSeq-NAT: A Modified Version of LightSeq for Non-Autoregressive Transformers

This repository is modified from [``lightseq:812d9d``](https://github.com/bytedance/lightseq/tree/812d9d798e491ab9139c1f36113693308c4c0637), see [DA-Transformer](https://github.com/thu-coai/DA-Transformer) for its application.
